...
send(msg.chat_id,msg.id,"✭ اهلا بك في صانع بوتات سورس النحوم \n✭ مطور البوت @S_E_M_O_E_L_K_B_E_R","html",true, false, false, true, reply_markup)
return false 
end
...
local T =[[
☆︙[𝑊𝐸𝐿𝐶𝑂𝑀𝐸 𝑇𝑂 𝑆𝑂𝑈𝑅𝐶𝐸 𝑉𝐴𝐿𝑂𝑅𝐴𝑁𝑇](t.me/LFY5bot )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '• مبرمج السورس •', url = 't.me/IH2ll '},
},
{
{text = '• تنصيب بوت مدفوع •', url = 't.me/IH2ll'},
},
{
{text = '• قناة التحديثات •', url = 't.me/LFY5bot '},
},
{  
{text = '• 𝑆𝑂𝑈𝑅𝐶𝐸 𝑉𝐴𝐿𝑂𝑅𝐴𝑁𝑇 •', url = 't.me/LFY5bot '},
},
}
